...
public class RunScriptWriteExcel
{
	public static void write(int row,int column,String msg)
	{
		try
		{
		FileInputStream file=new FileInputStream(System.getProperty("user.dir")+"\\Testcases\\Interest Amount Cal.xlsx");
		...
		FileOutputStream output_file=new FileOutputStream(System.getProperty("user.dir")+"\\Testcases\\Interest Amount Cal.xlsx");
